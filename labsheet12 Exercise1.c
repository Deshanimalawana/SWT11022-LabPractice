...
int main() {
    ...
    // f) Print pointer variables (addresses stored)
    ...
    // g) Dereference pointers
    printf("Value at int_var_pointer = %d\n", *int_var_pointer);
    printf("Value at float_var_pointer = %.3f\n", *float_var_pointer);
    printf("Value at char_var_pointer = %c\n", *char_var_pointer);
