...
int main() {
    ...
    // e) Initialize the pointers with the address of the variables
    int_var_pointer = &int_var;
    float_var_pointer = &float_var;
    char_var_pointer = &char_var;

    // f) Print pointer variables (addresses they are holding)
