...
int main() {
    ...
    printf("Values via pointer dereferencing:\n");
    printf("*int_var_pointer = %d\n", *int_var_pointer);
    printf("*float_var_pointer = %.3f\n", *float_var_pointer);
    printf("*char_var_pointer = %c\n\n", *char_var_pointer);

    printf("Pointer arithmetic:\n");
    printf("int_var_pointer = %p, int_var_pointer+1 = %p\n",
           (void*)int_var_pointer, (void*)(int_var_pointer + 1));
    printf("float_var_pointer = %p, float_var_pointer+1 = %p\n",
           (void*)float_var_pointer, (void*)(float_var_pointer + 1));
    printf("char_var_pointer = %p, char_var_pointer+1 = %p\n",
           (void*)char_var_pointer, (void*)(char_var_pointer + 1));
